    ...
    responsiville.$body.append(
        ...
        '<aside class = "responsiville-debug-controls ' + responsiville.options.debugPos + '">' +
            ...
            '<section class = "responsiville-debug-text">' +
                '<p>' + 
                    '<a class = "button button-small" href = "http://codex.wordpress.org/Function_Reference/" title = "WordPress function reference" target = "_blank">Codex functions</a>' +
                    '<a class = "button button-small" href = "http://codex.wordpress.org/Plugin_API/Action_Reference" title = "Codex hooks reference" target = "_blank">Codex hooks</a>' +
                    '<a class = "button button-small" href = "https://codex.wordpress.org/Plugin_API/Filter_Reference" title = "Codex filters reference" target = "_blank">Codex filters</a>' +
                    '<a class = "button button-small" href = "http://www.advancedcustomfields.com/resources/" title = "ACF docs" target = "_blank">ACF docs</a>' + 
                    '<a class = "button button-small" href = "http://www.php.net/" title = "PHP.net documentation" target = "_blank">PHP.net</a> <br />' + 
                    '<a class = "button button-small" href = "http://devdocs.io/html/" title = "Devdocs HTML" target = "_blank">Devdocs HTML</a>' + 
                    '<a class = "button button-small" href = "http://devdocs.io/css/" title = "Devdocs CSS" target = "_blank">Devdocs CSS</a>' + 
                    '<a class = "button button-small" href = "http://devdocs.io/javascript/" title = "Devdocs JS" target = "_blank">Devdocs JS</a> <br />' + 
                    '<a class = "button button-small" href = "http://vanilla.nevma.gr/" title = "Vanilla website" target = "_blank">Vanilla</a>' + 
                    ...
                    '<a class = "button button-small" href = "http://vanilladev.nevma.gr/" title = "Vanilla demo" target = "_blank">Vanilla demo</a> <br />' + 
