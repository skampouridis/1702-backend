...
Responsiville.Mobimenu = function ( options ) {
    ...
    // Check if the mobimenu is already wrapped due a possibly cloned mobimenu via a scrollmenu.

    var hasMobimenuWrapper = this.$menu.parent().is( '.responsiville-mobimenu-wrapper' );


    
    // Wrap the original menu in a container wrapper.

    if ( hasMobimenuWrapper ) {
